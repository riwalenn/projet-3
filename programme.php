...
<!-- ---------------------------------------------- 
	...
	<div class="row page-programme">
		<div class="col-xs-12 col-sm-6 col-md-3">
			...
			Durée 1h30<br />
			<a href="enemy.php" target="_self" alt="Détails sur le film Enemy">En savoir +</a></p>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-3">
			...
			Durée 2h13<br />
			<a href="#" target="_self" alt="Détails sur le film Vol au dessus d'un nid de coucou">En savoir +</a></p>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-3">
			...
			Durée 1h55<br />
			<a href="#" target="_self" alt="Détails sur le film Holy motors">En savoir +</a></p>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-3">
			...
			Durée 1h42<br />
			<a href="#" target="_self" alt="Détails sur le film Requiem for a dream">En savoir +</a></p>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-3">
			...
			Durée 2h28<br />
			<a href="#" target="_self" alt="Détails sur le film Into the wild">En savoir +</a></p>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-3">
			...
			Durée 1h41<br />
			<a href="#" target="_self" alt="Détails sur le film Demolition">En savoir +</a></p>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-3">
			...
			Durée 2h24<br />
			<a href="#" target="_self" alt="Détails sur le film The master">En savoir +</a></p>
		</div>
		<div class="col-xs-12 col-sm-6 col-md-3">
			...
			Durée 1h30<br />
			<a href="#" target="_self" alt="Détails sur le film le cercle des poètes disparus">En savoir +</a></p>
		</div>
	</div>
<!-- ---------------------------------------------- 
	                   FOOTER
